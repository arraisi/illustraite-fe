  ...
  <div class="space-y-8">
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-950">
      <div class="flex items-center justify-between">
        ...
        <div class="flex h-14 w-14 items-center justify-center rounded-2xl bg-amber-100 dark:bg-amber-900/30">
          <svg class="h-7 w-7 text-[#fe9a00]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div>
      ...
      <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
        <div
          ...
          :class="pkg.popular
            ? 'border-[#fe9a00] ring-1 ring-[#fe9a00]'
            : 'border-gray-200 dark:border-gray-800'"
        >
          <span
            v-if="pkg.popular"
            class="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-[#fe9a00] px-3 py-0.5 text-xs font-semibold text-white"
          >
            Popular
          </span>
